...
Приложение «Движ» распространяется под лицензией GNU GPL v3.0.

Модуль `yaMusicSdk` основан на проекте
[MarshalX/yandex-music-api](https://github.com/MarshalX/yandex-music-api),
который распространяется под лицензией GNU LGPL v3.0.
`yaMusicSdk` также распространяется под GNU LGPL v3.0.
Авторские права на оригинальный проект принадлежат его авторам
и участникам.
